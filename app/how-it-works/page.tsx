      ...
      <section className="bg-white py-14 sm:py-24 lg:py-[100px] px-6 lg:px-12 border-b border-gray-100">
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-4xl mx-auto">
            <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 hover:shadow-sm hover:border-gray-300 transition-all">
      ...
      <section className="bg-white py-14 sm:py-24 lg:py-[100px] px-6 lg:px-12">
        <div className="max-w-[1280px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto text-left">
            <div className="bg-white rounded-lg border border-gray-200 p-6 sm:p-8 lg:p-10 text-center hover:shadow-lg hover:border-primary/20 transition-all duration-200 flex flex-col items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-auto justify-center">
                <Link href="/register/hc" className="w-full sm:w-auto flex items-center justify-center px-7 py-3 text-[15px] bg-primary hover:bg-primary-dark text-white rounded-full font-semibold shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] hover:-translate-y-[1px] transition-all">
                  {t('ctaHcBtn')}
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 sm:p-8 lg:p-10 text-center hover:shadow-lg hover:border-primary/20 transition-all duration-200 flex flex-col items-center">
              ...
              <Link href="/register/bc" className="w-full sm:w-auto flex items-center justify-center px-7 py-3 text-[15px] bg-transparent border-[1.5px] border-primary text-primary hover:bg-primary hover:text-white rounded-full font-semibold transition-all mt-auto">
                {t('ctaBcBtn')}
              </Link>
            </div>
          </div>
