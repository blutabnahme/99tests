 ...
 { status: 500 }
  ...
  for (const adminId of adminIds) {
    await sendNotification({
      ...
      message: `Dr. ${fullName} from ${practiceName} has registered on the platform.`,
      notificationType: 'new_doctor_registered',
      referenceId: userId,
      referenceType: 'doctor',
      metadata: { doctor_name: fullName, practice: practiceName },
    });
  }
