...
export async function GET(request: Request) {
  try {
    ...
    let query = supabaseAdmin
      ...
      .select(`
        *,
        ...
        items:tt_recommendation_item(id, quantity, unit_price, test:tt_test_catalog(name, sku, laboratory:tt_laboratory(name)))
      `, { count: 'exact' })
    ...
    // Attach item counts and sum test costs
