        ...
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <Link href="/register/hc" className="w-full sm:w-auto flex items-center justify-center px-7 py-3 text-[15px] bg-primary hover:bg-primary-dark text-white rounded-full font-semibold shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] hover:-translate-y-[1px] transition-all flex-shrink-0">
                {t('heroCtaPrimary')}
              </Link>
        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              return (
                <div key={i} className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 hover:shadow-md transition-all duration-200">
                  <div className="w-11 h-11 rounded-lg bg-primary/10 flex items-center justify-center mb-3">
