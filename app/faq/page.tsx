...
export default function PublicFAQPage() {
 ...
 <Link href="/contact" className="inline-flex items-center justify-center px-7 py-3 text-[15px] bg-primary hover:bg-primary-dark text-white rounded-full font-semibold shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] transition-colors">
 {t('contactBtn')}
 </Link>
 </div>
 </section>
