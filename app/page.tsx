      ...
      <main className="flex-1">
        ...
        <section id="hero" className="pt-[140px] pb-20 px-6 lg:px-12 max-w-[1280px] mx-auto text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/register/doctor" className="w-full sm:w-auto flex items-center justify-center px-8 py-3.5 text-[16px] bg-primary hover:bg-primary-dark text-white rounded-full font-semibold shadow-md hover:-translate-y-[1px] transition-all">
              Jetzt starten &rarr;
            </Link>
          </div>
        </section>
