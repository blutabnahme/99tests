...
const formatDobForInput = (d: string) => {
  if (!d) return '';
  if (d.includes('-') && d.length === 10) return d; // Already YYYY-MM-DD
  const parts = d.split('.');
...
export default function PortalProfilePage() {
  ...
  const [profileTab, setProfileTab] = useState<'personal' | 'contact'>('personal');
        ...
        if (res.ok) {
          ...
          if (data.patient) {
            setForm({
              ...
              date_of_birth: formatDobForInput(data.patient.date_of_birth) || '',
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-[16px] border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex gap-1 border-b border-gray-100 mb-6 -mt-2">
            <button
