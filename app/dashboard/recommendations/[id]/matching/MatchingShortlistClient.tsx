...
export default function MatchingShortlistClient({ caseInfo, initialCollectors }: { caseInfo: any, initialCollectors: any[] }) {
 ...
 bg-white rounded-[18px] overflow-hidden transition-colors duration-200 border relative
 ...
 disabled={isSending}
 className="w-full sm:w-auto bg-primary-dark hover:bg-primary-dark disabled:opacity-70 text-white rounded-full px-6 py-3 text-[14px] font-bold flex items-center justify-center gap-2 shadow-sm shadow-primary-dark/20 transition-colors min-w-[200px]"
 >
 {isSending ? (
