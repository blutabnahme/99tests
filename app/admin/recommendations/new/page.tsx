        ...
        <div className="bg-white p-4 sm:p-6 border border-gray-200 rounded-lg shadow-sm space-y-5">
           ...
           <div className="flex justify-end pt-2">
             <button 
               type="submit"
               disabled={submitting}
               className="w-full sm:w-auto bg-primary text-white px-8 h-10 rounded-full font-semibold text-[14px] hover:bg-primary-dark transition-all shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] hover:-translate-y-[1px] flex items-center justify-center disabled:opacity-50"
             >
               {submitting ? (
                 <>
