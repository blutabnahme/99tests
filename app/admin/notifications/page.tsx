      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto mt-2 sm:mt-0">
          ...
          <button 
            ...
            className="flex-1 sm:flex-none h-9 flex items-center justify-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 text-near-black text-[12px] sm:text-[13px] font-semibold rounded-lg sm:rounded-full hover:bg-gray-50 transition-all shadow-sm"
          >
          ...
          <button 
            ...
            className="flex-1 sm:flex-none h-9 flex items-center justify-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 text-near-black text-[12px] sm:text-[13px] font-semibold rounded-lg sm:rounded-full hover:bg-red-50 hover:text-red-600 transition-all shadow-sm"
          >
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 lg:pb-0" style={{ scrollbarWidth: 'none' }}>
            {TABS.map(tab => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-[13px] shrink-0 font-semibold transition-all whitespace-nowrap ${
                  activeTab === tab 
          ...
          <div className="flex items-center gap-4 shrink-0">
            ...
            <div className="relative w-[300px] shrink-0">
              ...
              <input 
                ...
                className="h-9 w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-[13px] focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all placeholder:text-gray-400"
              />
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-3 p-3 border-b border-gray-100">
            ...
            <div className="relative flex-1 shrink-0">
              ...
              <input 
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="h-9 w-full pl-9 pr-4 py-2 bg-white border border-gray-200 rounded-lg text-[13px] focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all placeholder:text-gray-400"
              />
            </div>
          </div>
        </div>
