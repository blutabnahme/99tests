        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <button 
              ...
              className="group flex items-center gap-1.5 px-3 py-1.5 text-[12px] font-medium text-gray-500 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 hover:text-gray-700 transition-all disabled:opacity-50"
            >
            ...
            <div className="flex items-center gap-2 pl-14 sm:pl-0 shrink-0">
              ...
              {alert.link && (
                <Link href={alert.link}>
                  <Button variant="primary" className="h-10 px-5 rounded-full bg-primary hover:bg-primary-dark shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] hover:-translate-y-[1px] text-[13px] font-semibold flex items-center gap-2 transition-all">
                    Take Action
