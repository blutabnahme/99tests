    ...
    <div className="pb-32 min-h-screen">
      ...
      <div className="flex gap-2 mb-8 overflow-x-auto pb-2">
        {['all', 'patient', 'hc', 'bc', 'admin', 'system'].map(cat => (
          <button
            ...
            className={`px-4 py-2 rounded-full text-[13px] font-semibold transition-all capitalize whitespace-nowrap ${
              filter === cat 
      ...
      <div className="space-y-4">
        {filtered.map(t => {
          ...
          return (
            <div key={t.id} className={`bg-white rounded-2xl border transition-all ${isExpanded ? 'border-primary shadow-md' : 'border-gray-200 hover:border-gray-300'}`}>
                ...
                <div className="p-6 border-t border-gray-100 bg-gray-50/50 rounded-b-2xl">
                  ...
                  <div className="mt-8 flex justify-end gap-3 sticky bottom-4">
                    ...
                    <button 
                      onClick={handleSave}
                      disabled={isSaving}
                      className="px-6 py-2.5 rounded-full text-[14px] font-semibold text-white bg-primary hover:bg-primary-dark transition-all shadow-md flex items-center justify-center min-w-[120px]"
                    >
                      {isSaving ? (
