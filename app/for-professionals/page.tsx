...
export default function ForProfessionalsPage() {
 ...
 <Link href="/register/bc" className="w-full sm:w-auto flex items-center justify-center px-7 py-3 text-[15px] bg-primary hover:bg-[#157575] text-white rounded-full font-semibold transition-colors shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] flex-shrink-0">
 {t('heroCtaPrimary')}
 </Link>
 ...
 <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 hover:shadow-md hover:border-gray-300 hover:bg-gradient-to-br hover:from-white hover:to-teal-50/40 transition-colors duration-300 flex flex-col h-full group">
 ...
 return (
 <div key={i} className="bg-white rounded-xl border border-gray-200 p-5 sm:p-8 shadow-sm hover:shadow-md transition-colors flex flex-col">
 ...
 <Icon className="w-12 h-12 text-gray-300 mb-3 group-hover:scale-110 group-hover:text-[#008085]/40 transition-colors duration-500" strokeWidth={1.5} />
 ...
 <Link href="/register/bc" className="w-full sm:w-auto flex items-center justify-center px-7 py-3 text-[15px] bg-white text-primary rounded-full font-semibold shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] hover:bg-gray-50 transition-colors">
 {t('ctaPrimary')}
 </Link>
