...
export default function PricingPage() {
 ...
 <div>
 <Link href="/register/hc" className="flex items-center justify-center w-full px-7 py-3 text-[15px] bg-primary hover:bg-primary-dark text-white rounded-full font-semibold shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] transition-colors">
 {t('hcCardBtn')}
 </Link>
 ...
 <div>
 <Link href="/register/bc" className="flex items-center justify-center w-full px-7 py-3 text-[15px] bg-primary hover:bg-[#157575] text-white rounded-full font-semibold transition-colors">
 {t('bcCardBtn')}
 </Link>
 <div className="text-[12px] text-gray-400 mt-3 text-center">
 {t('bcCardNote')}
 ...
 <Link href="/register/hc" className="flex items-center justify-center px-7 py-3 text-[15px] bg-white text-primary rounded-full font-semibold shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] hover:bg-gray-50 transition-colors w-full sm:w-auto">
 {t('ctaHcBtn')}
 </Link>
 <Link href="/register/bc" className="flex items-center justify-center px-7 py-3 text-[15px] bg-white/10 text-white border border-white/15 hover:bg-white/20 rounded-full font-semibold transition-colors w-full sm:w-auto">
 {t('ctaBcBtn')}
 </Link>
 </div>
 </div>
