...
export default function AboutPage() {
 ...
 <div className="bg-white rounded-lg border border-gray-200 p-6 sm:p-8 lg:p-10 relative overflow-hidden group hover:shadow-lg transition-colors">
 ...
 <div className="bg-white rounded-lg border border-gray-200 p-5 sm:p-8 hover:shadow-lg transition-colors flex flex-col h-full relative overflow-hidden group">
 ...
 <div className="bg-white rounded-lg border border-gray-200 border-l-[3px] border-l-99tests-red/30 p-5 sm:p-6 hover:shadow-md hover:border-l-99tests-red transition-colors flex items-start gap-4 sm:gap-5">
 ...
 <Link href="/register/bc" className="w-full sm:w-auto flex items-center justify-center px-7 py-3 text-[15px] bg-white/10 text-white border border-white/15 hover:bg-white/20 rounded-full font-semibold transition-colors">
 {t('ctaBC')}
 </Link>
 </div>
 </div>
