...
export default function DoctorRegistrationPage() {
 ...
 {uploadingDoc ? (
   ...
   <span className="text-[14px] font-medium text-near-black">{docFile.name}</span>
 )}
 </div>
 {!uploadingDoc && (
 <button type="button" onClick={removeDocument} className="p-1.5 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-full transition-colors">
 <X className="w-4 h-4" />
 </button>
 )}
 </div>
 ...
 >
 <div className={`w-10 h-10 rounded-full flex items-center justify-center z-10 transition-colors shadow-sm ${
 ...
 className={`w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-2.5 rounded-full font-semibold text-[14px] transition-colors
