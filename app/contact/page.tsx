            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 sm:p-8">
              {isSubmitted ? (
                ...
                >
                  ...
                  <button 
                    type="submit"
                    className="flex items-center justify-center px-7 py-3 text-[15px] bg-primary hover:bg-primary-dark text-white rounded-full font-semibold shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] hover:-translate-y-[1px] transition-all w-full sm:w-auto mt-4"
                  >
                    {t('formSubmit')}
                  </button>
                </form>
