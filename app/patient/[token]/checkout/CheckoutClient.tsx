  ...
  return (
    <div>
      ...
      <Button 
        onClick={handlePay} 
        disabled={paying}
        className="w-full sm:w-auto bg-primary hover:bg-primary-dark text-white text-[16px] py-6 rounded-full font-semibold shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] hover:-translate-y-[1px] transition-all"
      >
