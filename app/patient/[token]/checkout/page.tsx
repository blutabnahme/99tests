...
export default async function PatientCheckoutPage({
 ...
 <label className="flex items-center justify-between p-4 rounded-xl border-2 border-primary bg-open-bg cursor-pointer transition-colors">
 ...
 <div className="w-[18px] h-[18px] rounded-full border-[5px] border-primary bg-white shrink-0 transition-colors" />
 </label>
 
 <label className="flex items-center justify-between p-4 rounded-xl border-2 border-gray-200 bg-white hover:border-gray-300 hover:shadow-sm cursor-pointer transition-colors">
 <div className="flex items-center gap-3">
 ...
 <div className="w-[18px] h-[18px] rounded-full border-2 border-gray-300 bg-white shrink-0 transition-colors" />
 </label>
