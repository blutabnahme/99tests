...
export function PatientHeader({ patient }: { patient: any }) {
 ...
 className="border border-gray-200 text-gray-500 hover:text-near-black hover:border-gray-300 bg-transparent rounded-full px-5 py-3 text-[14px] font-semibold flex items-center gap-2 transition-colors"
 >
 ...
 className="bg-primary hover:bg-primary-dark text-white rounded-full px-6 py-3 text-[14px] font-semibold flex items-center gap-2 transition-colors"
 >
 ...
 <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden max-h-[90vh] flex flex-col transform transition-colors">
 ...
 className="px-5 py-2.5 rounded-full font-semibold text-gray-500 hover:text-near-black border border-transparent hover:border-gray-300 hover:bg-transparent bg-transparent transition-colors text-[14px]"
 >
 {t('cancel')}
 </button>
 <button 
 ...
 disabled={isSaving}
 className="px-6 py-2.5 rounded-full font-semibold text-white bg-primary hover:bg-primary-dark transition-colors text-[14px] disabled:opacity-50"
 >
