...
export default function WizardStep1({ patient, setPatient, setPricingTier, onNext, urlPatientId }: any) {
 ...
 className="w-full h-12 pl-12 pr-4 text-[14px] bg-gray-50 border border-gray-200 rounded-full focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors placeholder:text-gray-400"
 />
 ...
 className="w-full text-left p-4 rounded-[16px] border border-gray-200 hover:border-primary hover:bg-primary/5 transition-colors flex items-center justify-between group"
 >
 ...
 className="flex-1 rounded-full bg-[#008085] text-white py-3 px-7 text-[15px] font-semibold shadow-[0_4px_16px_rgba(0,128,133,0.25)] hover:bg-[#005C5F] transition-colors"
 >
 Continue to Tests
 </button>
 </div>
