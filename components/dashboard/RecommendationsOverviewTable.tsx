      ...
      <div className="p-6 border-b border-gray-200 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
          ...
          {tabs.map(tab => {
            ...
            return (
              <button
                ...
                className={`py-2 text-[13px] font-semibold transition-all duration-150 whitespace-nowrap border-b-2 ${
                  isActive 
        ...
        <div className="relative w-full sm:w-[300px]">
          ...
          <input 
            ...
            className="w-full pl-9 pr-4 py-2 border border-gray-200 rounded-lg text-[13px] focus:outline-none focus:ring-2 focus:ring-primary-dark/20 focus:border-primary-dark transition-all placeholder:text-gray-400"
          />
        </div>
      </div>
              ...
              >
                ...
                <td className="px-6 py-4 text-right relative" onClick={handleDropdownClick}>
                  ...
                  <div className="relative group/dropdown inline-block text-left">
                    ...
                    {/* Dropdown Menu */}
                    <div className="absolute right-0 mt-1 w-48 bg-white border border-gray-200 rounded-xl shadow-lg opacity-0 invisible group-hover/dropdown:opacity-100 group-hover/dropdown:visible group-focus-within/dropdown:opacity-100 group-focus-within/dropdown:visible transition-all z-10 overflow-hidden transform origin-top-right scale-95 group-hover/dropdown:scale-100 group-focus-within/dropdown:scale-100">
                      <div className="py-1">
                        <button 
