...
export function CopyConsentHeaderButton({ token }: { token: string }) {
 ...
 href={url}
 target="_blank"
 className="bg-transparent border border-gray-200 text-gray-500 hover:border-gray-300 hover:text-near-black rounded-full px-4 py-2 text-[13px] font-semibold flex items-center gap-2 transition-colors"
 >
 ...
 <button 
 onClick={handleCopy}
 className="bg-transparent border border-gray-200 text-gray-500 hover:border-gray-300 hover:text-near-black rounded-full p-2 text-[13px] font-semibold flex items-center justify-center transition-colors"
 title="Copy Link"
 >
...
export function PatientConsentCard({ token }: { token: string }) {
 ...
 <button 
 onClick={handleCopy}
 className="bg-transparent border border-gray-200 text-gray-500 hover:border-gray-300 hover:text-near-black rounded-full px-3 py-1.5 text-[12px] font-semibold flex items-center gap-1.5 transition-colors whitespace-nowrap"
 >
