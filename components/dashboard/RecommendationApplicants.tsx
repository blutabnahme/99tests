              ...
              <div key={app.id} className="p-4 rounded-xl border border-gray-200 bg-gray-50/50 flex flex-col gap-3">
                <div className="flex justify-between items-start">
                  ...
                  <button 
                    ...
                    className="text-[13px] bg-transparent border border-gray-200 text-gray-500 hover:border-gray-300 hover:text-near-black font-semibold px-4 py-2 rounded-full transition-all"
                  >
                    {t('reviewBid')}
                  </button>
                </div>
          ...
          <div className="bg-white w-full max-w-[600px] rounded-2xl shadow-2xl relative my-auto animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50 rounded-b-2xl flex justify-between gap-3 shrink-0 items-center">
              ...
              {selectedApp.status === 'applied' && selectionMode !== 'patient_decides' ? (
                  ...
                  {selectionMode === 'clinic_shortlist' ? (
                    <>
                      <button 
                        ...
                        disabled={updating}
                        className="px-5 py-2.5 rounded-full font-semibold text-[13px] text-white bg-red-600 hover:bg-red-700 transition-all disabled:opacity-50"
                      >
                        {t('reject')}
                      </button>
                      <button 
                        ...
                        disabled={updating}
                        className="px-6 py-2.5 rounded-full font-semibold text-[13px] text-white bg-primary hover:bg-primary-dark transition-all disabled:opacity-50 flex items-center gap-2"
                      >
                ...
                <button 
                  onClick={() => setSelectedApp(null)}
                  className="px-6 py-2.5 rounded-full font-semibold text-[13px] bg-transparent border border-gray-200 text-gray-500 hover:border-gray-300 hover:text-near-black transition-all"
                >
                  {t('close')}
                </button>
              )}
