          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-gray-200">
            ...
            <div className="hidden sm:block p-3">
              ...
              <div className="relative group w-full sm:w-auto">
                ...
                <div className="absolute right-0 top-full w-48 bg-white border border-gray-200 rounded-xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10 flex flex-col py-1">
                  {types.map((type) => (
                    <button
                      key={type.value}
