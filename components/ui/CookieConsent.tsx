...
export function CookieConsent() {
 ...
 <button 
 disabled
 className="w-11 h-6 shrink-0 bg-primary rounded-full relative cursor-not-allowed opacity-70 transition-colors duration-200"
 >
 <span className="absolute left-[2px] top-[2px] w-[20px] h-[20px] bg-white rounded-full translate-x-5 transition-colors duration-200" />
 </button>
 </div>
 ...
 className={`w-11 h-6 shrink-0 rounded-full relative transition-colors duration-200 ${preferences.analytics ? 'bg-primary' : 'bg-gray-200'}`}
 >
 <span className={`absolute left-[2px] top-[2px] w-[20px] h-[20px] bg-white rounded-full transition-colors duration-200 ${preferences.analytics ? 'translate-x-5' : 'translate-x-0'}`} />
 </button>
 </div>
 ...
 className={`w-11 h-6 shrink-0 rounded-full relative transition-colors duration-200 ${preferences.marketing ? 'bg-primary' : 'bg-gray-200'}`}
 >
 <span className={`absolute left-[2px] top-[2px] w-[20px] h-[20px] bg-white rounded-full transition-colors duration-200 ${preferences.marketing ? 'translate-x-5' : 'translate-x-0'}`} />
 </button>
 </div>
 </div>
