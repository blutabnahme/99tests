...
export function PhoneInput({ prefix, onPrefixChange, value, onChange, placeholder = "176 1234 5678" }: PhoneInputProps) {
 return (
 <div className="flex items-center h-11 rounded-full border border-gray-200 bg-white focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-colors overflow-visible">
