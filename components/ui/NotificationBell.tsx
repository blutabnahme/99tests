...
export function NotificationBell() {
 ...
 {isOpen && (
 <div className="absolute top-12 right-0 w-[360px] max-w-[calc(100vw-2rem)] bg-white border border-gray-200 rounded-xl shadow-lg z-50 overflow-hidden flex flex-col transform origin-top-right transition-colors">
