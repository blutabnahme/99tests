...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
 ...
 <input
 type={type}
 className={`flex-1 w-full min-w-0 px-4 py-2 h-[42px] bg-white border border-[#D4D4D4] text-[14px] font-body text-near-black placeholder-[#9CA3AF] outline-none transition-colors focus:border-primary focus:ring-[3px] focus:ring-primary/10 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-400 ${
