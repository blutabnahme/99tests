...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
 ...
 switch (variant) {
 case "primary":
 variantClasses = "bg-primary text-white border border-transparent hover:bg-primary-dark shadow-[0_4px_16px_rgba(0, 128, 133,0.25)] ";
 break;
 case "secondary":
