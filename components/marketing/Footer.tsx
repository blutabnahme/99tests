...
export function Footer() {
 ...
 <button className="flex items-center gap-2 px-2.5 py-1 border border-white/15 rounded-full bg-transparent text-[13px] font-medium text-gray-500 hover:border-white/30 hover:text-gray-400 transition-colors" onClick={() => setFooterLangOpen(!footerLangOpen)}>
